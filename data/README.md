...
서울시 공공데이터포털에서 제공하는 공간 데이터, 인구 통계 데이터, 교통 이용 데이터를 활용합니다.

| 데이터명 | 파일명 | 설명 | 출처 |
| :--- | :--- | :--- | :--- |
| **행정동 단위 서울 생활인구(내국인)** | `seoul_living_pop_dong_2025.csv` | 특정 시점(일 단위) 행정동 내 상주 및 유동인구 규모 파악 | [링크](https://data.seoul.go.kr/dataList/OA14991/A/1/datasetView.do) |
| **서울시 상권분석서비스(행정동)** | `dong_area.csv` | 각 행정동의 좌표 및 영역 정보를 수집하여 공간 매핑 기준점으로 활용 | [링크](https://data.seoul.go.kr/dataList/OA14991/A/1/datasetView.do) |
